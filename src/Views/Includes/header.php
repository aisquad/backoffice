      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a id="signout-link" href="/logout" class="dropdown-item d-flex align-items-center">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center shadow">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center shadow">
                ...
                <span id="app-version">Backoffice 1.0.34</span>
              </a>
            </li>
